...
\begin{figure}[H]
    ...
    \centering
    \caption[Exemple d'un CFG pour le branch coverage]{Exemple d'un CFG pour le branch coverage \cite{concept_cfg}}
\end{figure}
...
À travers ce chapitre, nous avons pu constater si \texttt{SourceCode} est un projet qui tient la route à son stade de développement.\\
