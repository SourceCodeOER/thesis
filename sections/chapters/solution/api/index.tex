...
La grande force de cette approche est qu'elle permet de déléguer\footnote{
    On peut citer par exemple l'authentification (cf section \ref{section:AnalyseNonFonctionnelle} - partie "Sécurité"), la validation des requêtes, ...
} et se concentrer ainsi sur l'essentiel. Il est également possible de combiner plusieurs \glspl{middleware} en un seul dans une même "couche", par des \gls{library} comme connect-chain-if
\footnote{
