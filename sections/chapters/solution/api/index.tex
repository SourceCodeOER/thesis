...
Notre implémentation repose sur un champ précalculé\footnote{
    Par soucis de performance, il est préférable d'avoir cette information directement, plutôt que la calculer sur la table intermédiaire entre les \glspl{fiche} et les \glspl{tag} à chaque fois.
...
\footnote{
   ...
   le $\land$ s'effectue sur les élements du premier niveau tandis que le $\lor$ s'effectue lui sur le 2e niveau
