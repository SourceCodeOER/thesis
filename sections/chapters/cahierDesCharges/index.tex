...
Pour la partie \gls{backend}, il nous a été imposé de travailler avec une base de données relationnelle\footnote{\url{https://fr.wikipedia.org/wiki/Base_de_donn%C3%A9es_relationnelle}} dont PostgreSQL\footnote{\url{https://www.postgresql.org/}} a été le système de gestion imposé.
Ce type de base de données dispose de propriétés très intéressantes dont notammes les \textbf{ACID}\footnote{\url{https://fr.wikipedia.org/wiki/Propri%C3%A9t%C3%A9s_ACID}} :
...
Étant donné que ces propriétés sont assez contraignantes, le lecteur / lectrice attentif / attentive que vous êtes est en droit de remettre en question cette contrainte technique et il est donc utile de recourir au théorème \textbf{CAP} pour la justifier.
