...
\begin{itemize}
    ...
    \item[\textcolor{red}{\textbf{M}}] Changer l'état d'une \gls{fiche}  lui appartenant
    \item[\textcolor{red}{\textbf{M}}] Proposer un nouveau ou plusieurs mot(s) clé(s)
    \item[\textcolor{orange}{\textbf{S}}] Évaluer une \gls{fiche}  
    \item[\textcolor{orange}{\textbf{S}}] Gestion de favoris
    \item[\textcolor{orange}{\textbf{S}}] Utilisation des favoris dans la recherche de \gls{fiche}s
\end{itemize}
