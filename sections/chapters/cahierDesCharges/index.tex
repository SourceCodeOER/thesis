...
\begin{itemize}
    ...
    \item[\textcolor{red}{\textbf{M}}] Changer l'état d'une \gls{fiche} lui appartenant (cf figure \ref{pic:stateDiagramForFiches} : pour éviter des dérives, seuls les états \textbf{DRAFT} et \textbf{PENDING} sont possibles pour ce rôle spécifique)
