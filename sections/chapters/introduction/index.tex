...
Nous réalisons ce travail dans le cadre de notre formation de Master en Sciences Informatiques. L'objectif premier de ce mémoire est donc de conclure nos études avec un projet axé sur le développement.\\

Ce mémoire nous permet de mettre en oeuvre ce qui a été enseigné durant notre cursus académique. Partant de rien, si ce n'est qu'avec la vision et les objectifs de nos promoteurs, nous devons en toute autonomie sortir de notre zone de confort pour apporter une solution au problème des \glspl{resinfo} partagées.\\
...
Avant de démarrer la réalisation de la plateforme web, nous devions impérativement définir les besoins d'une plateforme de partage de \glspl{resinfo}. Cette phase d'analyse s'est déroulée en deux parties.\\

La première partie consistait à analyser des plateformes similaires existantes afin d'en extraire des éléments visuels ou fonctionnels pertinents pour ce projet. En dernière partie, il nous fallait effectuer d'une part, une analyse fonctionnelle regroupant l'organisation de la plateforme et les fonctionnalités à intégrer avec la méthode \textit{\textbf{MoSCoW}}, et d'autre part une analyse non fonctionnelle afin d'y relater les diverses contraintes du projet, les critères de sécurité et de maintenance.\\

Après cette phase analyse, nous nous sommes attelés à l'achitecture de \texttt{SourceCode} à l'aide d'un patchwork présentant les fonctionnalités essentielles de l'application coté \gls{frontend} et de schémas UML pour la base de données.\\
