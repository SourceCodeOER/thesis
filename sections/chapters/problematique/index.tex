...
Il était important pour nous d'effectuer cette analyse car elle nous a permis de partir sur de bonnes bases pour la création de notre application web. Dans la section suivante, nous avons exposé notre patchwork découlant de cette analyse. Nous voulions nous inspirer de certaines interfaces proposant de bonnes idées au niveau de la recherche pure car cette dernière sera l'une des fonctionnalité principale de \texttt{SourceCode}.
