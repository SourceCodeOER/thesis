...
% les différentes types de phase par lesquelles on est passé
% - Analyse
% - Architecture
% - Implémentation
% - Validation / Testing
...
\begin{itemize}
    \item Effectuer des recherches bibliographiques concernant l'étiquetage de ressources informatiques.
...
% Pas grand chose à en dire dessus, je préfère les aborder dans leurs parties dédiées 

% TODO - je cherches quoi dire

\subsection*{Rédaction}

% Nop vu qu'on l'a fait ensemble et qu'on s'est relu ;) Ici, je comptes juste dire qu'on a pris le temps de bien le rédiger afin d'avoir un esprit critique 

% Haha ok : juste un label à faire
