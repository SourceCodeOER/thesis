...
\newglossaryentry{rest}
{
    ...
    description={
        ...
        Style d'architecture définissant des contraintes/conventions techniques pour concevoir des services communiquant par le web.
    }
}
...
% TODO
% fiche , mot clé , catégorie de mot clé, 